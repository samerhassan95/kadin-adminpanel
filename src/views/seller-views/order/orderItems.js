            ...
            <div className='d-flex align-items-center justify-content-between'>
              ...
              <div className='mt-2 text-right shop-total'>
                ...
                <Space>
                  ...
                  <p>
                    {numberToPrice(total.delivery_fee?.reduce((acc, curr) => acc + curr, 0), data.currency?.symbol)}
                  </p>
                </Space>
                <div />
                <Space>
                ...
                <Space>
                  ...
                  <p>-{numberToPrice(total.coupon?.reduce((acc, curr) => acc + curr, 0), data.currency?.symbol)}</p>
                </Space>
                <div />
                <Space>
                  <p className='font-weight-bold'>{t('service.fee')}:</p>
                  <p>{numberToPrice(total?.service_fee, data.currency?.symbol)}</p>
                </Space>
                <div />
                <Space>
